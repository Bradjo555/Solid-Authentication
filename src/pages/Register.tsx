...
const Register = () => {
    ...
    return (
        <form class="flex flex-col gap-5 border w-96 mx-auto p-5">
            ...
            <button class="bg-[#E61046] px-5 py-3 font-bold rounded-md text-light" onclick={createUser}>Create account</button>
            <button class="bg-[#7805CD] px-5 py-3 font-bold rounded-md text-light flex items-center justify-center gap-3" onclick={createUserWithGoogle}>
